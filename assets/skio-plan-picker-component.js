...
export class SkioPlanPicker extends LitElement {
  ...
  static styles = [
    css`
      ...
      .group-container {
        ...
        border-top: var(--skio-group-border-width, 1px) solid var(--skio-group-border-color, #ccc);
      ...
      /* additional styles */
      select.selling-plan-dropdown:has(option:only-child) {
        display: none;
      }
      ...
      @media (max-width: 425px) {
        ...
        .group-container--selected .skio-price s {
          font-size: 16px;
                    ...
                    <div class="group-topline">
                      ...
                      <div class="group-title">
                        ...
                        ${this.discountText(group.selected_selling_plan)
                          ...
                          : html``}
                        ${this.tooltipContent ? html`<span class="skio-tooltip" tabindex="0" aria-describedby="skio-tooltip-${this.key}-${index}">
  ...
  replacePlaceholders(template, sellingPlan = this.selectedSellingPlan) {
    ...
    const discountText = this.options?.discount_format === 'absolute'
    ...
    return template
      ...
      .replaceAll('[future_price_adjustments]', futureDiscountsText);
  }
